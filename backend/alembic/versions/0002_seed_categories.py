...
CATEGORIES = [
    ...
    ("Utilities",          "expense", "#3B82F6", "zap",               6),
    ("Internet & Phone",   "expense", "#8B5CF6", "wifi",              7),
    ("Health & Medical",   "expense", "#EC4899", "heart",             8),
    ("Entertainment",      "expense", "#F59E0B", "tv",                9),
    ("Streaming Services", "expense", "#6366F1", "play",              10),
    ("Clothing",           "expense", "#84CC16", "shirt",             11),
    ("Personal Care",      "expense", "#06B6D4", "scissors",          12),
    ("Education",          "expense", "#D946EF", "book",              13),
    ("Childcare",          "expense", "#F43F5E", "baby",              14),
    ("Gifts & Donations",  "expense", "#10B981", "gift",              15),
    ("Travel",             "expense", "#0EA5E9", "plane",             16),
    ("Home Improvement",   "expense", "#A78BFA", "hammer",            17),
    ("Pet Care",           "expense", "#FB923C", "paw-print",         18),
    ("Auto Insurance",     "expense", "#64748B", "shield",            19),
    ("Miscellaneous",      "expense", "#6B7280", "more-horizontal",   20),
    # Income categories
